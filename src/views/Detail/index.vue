        ...
        <div class="container">
            <div class="bread-container">
                <el-breadcrumb separator=">">
                    ...
                    <el-breadcrumb-item :to="{ path: `/category/${detailInfo?.categories?.[1]?.id}` }">{{
                        detailInfo?.categories?.[1]?.name }}
                    </el-breadcrumb-item>
                    <el-breadcrumb-item :to="{ path: `/category/sub/${detailInfo?.categories?.[0]?.id}` }">{{
                        detailInfo?.categories?.[0]?.name }}
                    </el-breadcrumb-item>
            ...
            <div class="info-container">
                <div>
                    <div class="goods-info" v-loading="loading">
                        <div class="media">
                            <!-- 图片预览区 -->
                            <ImageView :imageList="detailInfo.mainPictures" />
                            <!-- 统计数量 -->
                            ...
                            <div class="goods-tabs">
                                ...
                                <div class="goods-detail">
                                    ...
                                    <div class="imgContainer">
                                        <img v-for="item in detailInfo?.details?.pictures" :src="item" :key="item">
                                    </div>
                                </div>
                            </div>
                        </div>

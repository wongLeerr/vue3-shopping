...
const rules = {
    account: [{ required: true, message: '请输入有效的用户名', trigger: 'blur' }],
    password: [{ required: true, message: '请输入有效的密码', trigger: 'blur' }, { min: 6, max: 14, message: '密码应为6-14位的有效字符', trigger: 'blur' }],
    // 自定义校验规则
    agree: [
        {
        ...
        <section class="login-section">
            <div class="wrapper">
                ...
                <div class="account-box">
                    <div class="form">
                        <el-form ref="formInstance" :model="formData" :rules="rules" label-position="right"
